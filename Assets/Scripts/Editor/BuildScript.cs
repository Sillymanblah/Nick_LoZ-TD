...
public class BuildScript
{
    ...
    {
        BuildPlayerOptions buildPlayerOptions = new BuildPlayerOptions();
        buildPlayerOptions.scenes = new[] { "Assets/Scenes/Main Menu/MainMenu.unity", "Assets/Scenes/Sacred Forest Meadow.unity", "Assets/Scenes/Bombchu Bowling Alley.unity" };
